...
import static com.gundam.gdapicommon.constant.RabbitmqConstant.ORDER_SUCCESS_QUEUE_NAME;
import static com.gundam.gdapicommon.constant.RedisConstant.EXIST_KEY_VALUE;
import static com.gundam.gdapicommon.constant.RedisConstant.SEND_ORDER_PAY_SUCCESS_INFO;
...
//    private ApiBackendService apiBackendService;
    ...
    public void receiveOrderMsg(String outTradeNo, Message message, Channel channel) throws IOException {
        ...
        boolean updateInvokeCount = innerUserInterfaceInfoService.updateUserInterfaceInvokeCount(userId, interfaceId, count);
