...
import com.gundam.gdapi.common.DeleteRequest;
...
import com.gundam.gdapi.model.dto.user.UserAddRequest;
import com.gundam.gdapi.model.dto.user.UserLoginRequest;
import com.gundam.gdapi.model.dto.user.UserQueryRequest;
import com.gundam.gdapi.model.dto.user.UserRegisterRequest;
import com.gundam.gdapi.model.dto.user.UserUpdateMyRequest;
...
//import com.gundam.gdapi.utils.FileUploadUtil;
...
//    }
    ...
    public BaseResponse updateUserAvatar(@RequestParam(required = false) MultipartFile file, HttpServletRequest request) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "上传文件失败!");
        }
